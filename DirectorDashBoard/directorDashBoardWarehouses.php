...
<head>
    ...
    <title>Цеха и склады. Дашборд начальника цеха "АО "ТЗ "Ревтруд"</title>
        ...
        <ul class="menu">
          ...
          <li style="background: white;">
            <a href="/../directorDashBoard/directorDashBoardWarehouses.php">
                <img src = '/../svg/warehouse-svgrepo-com.svg' style = 'width: 50px; margin-left: 20%;'><span style = 'color:black;'>Цеха и склады</span></a>
          </li>
          <li>
        <div class = 'line'></div>
            <a href="#">
...
<div class = 'info-div' id = 'info-div'>Цеха и склады</div>


<div id = 'main-div-flex'style = 'display:flex;'>
  <div id = 'child-div-flex'style = 'display:flex;margin-left:110px;flex-wrap:wrap;'>
  ...
  $total_count = 0;
  $id = 0;
  $result = mysqli_query($conn,"SELECT * FROM warehouse;"); // запрос на выборку
  while($row = $result->fetch_assoc())// получаем все строки в цикле по одной
  {
$count++;
if($count == 1)
{
  echo  "<div class='post-item' style = 'width:300px;height: 250px;'>
      <div class='item-content' style = 'height: 250px;'>
          <div class='item-body'>
            <h3>Склад: №".$row['ID']."</h3>
            <p style = 'color:black;'>".$row['name']."</p>
          </div>
        <div class='item-footer'>
          <a href='#' class='link'><span>Загруженность: <span id = 'workload-text-".$id."'>".$row['workload']."</span>%</span><br><span>МОЛ: ".$row['MOL']."</span></a>
        </div>";
echo "<div id = 'workload-".$id."' style = 'background: white;
margin-top: -225.5px;
padding: 0;
margin-left: -15px;
height: 0px;
...
{
  echo  "<div class='post-item' style = 'width:300px;height: 250px;margin-top:-".$px."px;'>
      <div class='item-content' style = 'height: 250px;'>
          <div class='item-body'>
            <h3>Склад: №".$row['ID']."</h3>
            <p style = 'color:black;'>".$row['name']."</p>
...
echo '<div id = "total-count" style = "display:none;" >'.$total_count.'</div>';
  ?>
<!--</div> child-flex-end-->
  </div> <!--main-flex-end-->
  ...
  <div id = 'main-div-flex'style = 'display:flex;'>
  <div id = 'child-div-flex'style = 'display:flex;margin-left:110px;flex-wrap:wrap;width:70%'>

  <?php
  $count = 0;
  $result = mysqli_query($conn,"SELECT * FROM division"); // запрос на выборку
  while($row = $result->fetch_assoc())// получаем все строки в цикле по одной
  {
    
   echo  "<div class='post-item' style = 'width:300px;height: 250px;margin-bottom:20px;'>
      <div class='item-content' style = 'height: 250px;'>
          <div class='item-body'>
            <h3>Цех: №".$row['ID']."</h3>
            <p style = 'color:black;'>".$row['name']."</p>
        ...
        <div class='item-footer'>
          <a href='#' class='link'><span id = 'now-works-text'>МОЛ: ".$row['MOL']."</span></a>
        </div>
</div>
</div>";
...
<script src="/../js/directorDashBoardWarehouses.js"></script>
</body>
</html>