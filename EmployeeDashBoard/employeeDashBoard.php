...
<head>
    ...
    <title>Дашборд сотрудника "АО "ТЗ "Ревтруд"</title>
...
<header class="main-head">
      <nav class="head-nav">
        <ul class="menu">
          ...
          <li>
            <a href="#">
                <img src = '/../svg/gear-svgrepo-com.svg' style = 'width: 50px; margin-left: 20%;'><span>Информация о ДСЕ</span></a>
          </li>
          <li>
        <div class = 'line'></div>
            <a href="#">
                <img src = '/../svg/login-svgrepo-com.svg' style = 'width: 50px; margin-left: 20%;'><span style = 'color:black; font-weight: bold;'>
          ...
          <li>
            <a href="/../page-login.html">
                <img src = '/../svg/exit-svgrepo-com.svg' style = 'width: 50px; margin-left: 20%;'><span>Выход</span></a>
          </li>
        </ul>
      </nav>
</header> <!-- //main-head -->
